...
Currently dynamic encryption is exercised in voip phone calls by a company known as Dencrypt [https://www.dencrypt.dk/dynamic-encryption/] according to the explanation of their proprietary algorithm they use a wrapper on top of AES-256 which is a chosen algorithm that is discarded when the data transfer is finished.

Machine learning has been known to be used for secure communications although it is not clear if it is used in servers with valuable data. Google's AI successfully created secure algorithms [https://techcrunch.com/2016/10/28/googles-ai-creates-its-own-inhuman-encryption/] that use inhuman cryptographic schemes making them harder to crack. This technique is called GAN Cryptography [https://arxiv.org/abs/1610.06918] for which a research paper can be found.

This project will be compatible with NodeJs because it is one of the fastest growing server platform [https://w3techs.com/technologies/details/ws-nodejs/all/all] that can be easily set up and supports a large amount of modules.
